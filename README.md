...
// structuredContent (state = "completed")
{
  ...
  artifacts: Array<{ uri: string; found_at: string[]; path?: string; content_type?: string | null; size?: number; error?: ToolError }>;
