...
// output is its report. `scripts/smoke.ts` writes the same way.
...
const alpicTokens = path.join(ROOT, "node_modules/@alpic-ai/ui/src/styles/tokens.css");
if (fs.existsSync(alpicTokens)) {
